...
const TeacherExcel = (props) => {
  ...
  const generateExcel1 = () => {
    ...
    worksheet2.getCell(`B1`).value =  'Enrollment_No';
    ...
    worksheet2.getCell(`F1`).value =  'Class';
    ...
    for (let i = 0; i < props.client.length; i++) {
        ...
        worksheet2.getCell(`F${i + 2}`).value =  "";
    ...
    workbook.xlsx.writeBuffer().then((buffer) => {
      ...
      saveAs(data, 'teacher_sheet.xlsx');
    });
  };
